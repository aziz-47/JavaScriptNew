...
const { ad, konum, email } = birey; //Birey nesnesindkei propertyleri okumak icin ayristirir.
console.log(ad, konum, email);
birey.ad = "Mustafa"; //Birey dizisindeki adi gunceler
console.log(birey);
